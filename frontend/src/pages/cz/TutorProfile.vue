<template>
	<div class="min-h-screen bg-surface-gray-1">
		<header class="sticky top-0 z-10 flex items-center justify-between border-b bg-surface-white px-3 py-2.5 sm:px-5">
			<Breadcrumbs
				class="h-7"
				:items="[{ label: __('Tutor Profile'), route: { name: 'TutorProfile' } }]"
			/>
		</header>
				...
				<form @submit.prevent="saveProfile" class="space-y-5">
					...
					<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
						<div>
							...
							<input
								v-model.number="form.years_of_experiance"
								type="number"
								min="0"
								required
								placeholder="e.g. 5"
					...
					<div>
						...
						<div class="grid grid-cols-2 sm:grid-cols-3 gap-2 bg-surface-gray-1 p-4 rounded-lg border border-outline-gray-2">
							<label
					...
					<div class="space-y-3 pt-2 border-t border-outline-gray-1">
						...
						<div v-else class="text-sm text-ink-gray-4 bg-surface-gray-1 border border-dashed border-outline-gray-2 rounded-lg p-4 text-center">
